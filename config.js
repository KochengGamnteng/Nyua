...
/*============== NOMOR ==============*/
global.nomorbot = '-'
global.nomorown = '6285947577307'
global.namebot = 'ᴋᴏᴄʜᴇɴɢʙᴏᴛ'
global.nameown = 'ᴅᴏᴅᴏʟᴢ'


/*============== STAFF ==============*/
global.owner = [
  ['6285947577307', 'Dodolz', 'true']

 // [number, dia creator/owner?, dia developer?]
] // Put your number here
global.mods = ['6289512696170']  // Want some help?
...
/*============== WATERMARK ==============*/
global.wm = 'ɞᴋᴏᴄʜᴇɴɢʙᴏᴛʚ' //Main Watermark
global.wm2 = 'ɞᴋᴏᴄʜᴇɴɢʙᴏᴛʚ'
global.wm3 = 'ɞᴋᴏᴄʜᴇɴɢʙᴏᴛʚ'
global.botdate = `⻝ Tanggal: ${week} ${date}\n⻝ Waktu: ${wktuwib}`
global.bottime = `⻝ W A K T U : ${wktuwib}`
global.titlebot = `ɞᴋᴏᴄʜᴇɴɢʙᴏᴛ | ʙʏ ${global.nameown}ʚ`
global.author = 'ᴋᴏᴄʜᴇɴɢ ʙᴏᴛ' 
global.packname = 'ᴡᴀ ʙᴏᴛ'
global.danied = '〈❗〉ᴀᴋsᴇs ᴅɪᴛᴏʟᴀᴋ'
...
/*============== GLOBAL BIO ==============*/
global.nameowner = 'ʜᴀғɪᴅ'
global.umurowner = '13'
global.asalowner = 'ᴊᴀᴛɪᴍ, ᴍᴀᴅɪᴜɴ'
global.nomorowner = 'wa.me/6281230926688'
global.pacarowner = 'ᴜᴅᴀʜ ᴘᴜᴛᴜs ᴋᴇᴋ ᴛᴀʟɪ'
...
/*============== STICKER WM ==============*/
global.stickpack = 'ᴋᴏᴄʜᴇɴɢ ʙᴏᴛ'
global.stickauth = `ᴄᴏɴᴛᴀᴄᴛ ᴜs 087816288498`
